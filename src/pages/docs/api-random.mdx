...
The Random API can create a random color in any of the seven [formats](/docs/formats).
...
A color of type [Cmyk](/docs/formats#cmyk).
...
A color of type [Hex](/docs/formats#hex).
...
A color of type [Hsl](/docs/formats#hsl).
...
A color of type [Hsv](/docs/formats#hsv).
...
A color of type [Lab](/docs/formats#lab).
...
A color of type [Rgb](/docs/formats#rgb).
...
A color of type [Xyz](/docs/formats#xyz).
...
The **getRandomColor** method creates a random color in any of the seven [formats](/docs/formats).
...
Returns an object of type [ColorFormats](/docs/typescript-colors#colorformats) with a random color in many or a single format.
