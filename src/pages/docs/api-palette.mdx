...
- **_color:_** Color of type [Color](/colors-kit-docs/docs/typescript-colors#color), the color which the color palette will start, random HSL color if not sent.
...
An array of colors of type [Color](/colors-kit-docs/docs/typescript-colors#color) that make an analogous color palette.
...
An array of colors of type [Color](/colors-kit-docs/docs/typescript-colors#color) that make a complementary color palette of 2 colors.
...
An array of colors of type [BaseColor](/colors-kit-docs/docs/typescript-colors#basecolor) that make a color palette.
...
An array of colors of type [Color](/colors-kit-docs/docs/typescript-colors#color) that make a monochromatic color palette of **x** colors.
...
An array of colors of type [Color](/colors-kit-docs/docs/typescript-colors#color) that make a color palette of 3 colors.
...
An array of colors of type [Color](/colors-kit-docs/docs/typescript-colors#color) that make a color palette of 4 colors.
...
- **_color:_** Color of type [Color](/colors-kit-docs/docs/typescript-colors#color) to use as base color, it should match the selected **format**.
- **_paletteType (required):_** A string of type [Palette](/colors-kit-docs/docs/typescript-colors#palette) to select the type of color palette you want.
...
An array of colors of type [Color](/colors-kit-docs/docs/typescript-colors#color) that make a color palette.
