...
**_color:_** An object of type [Cmyk](/colors-kit-docs/formats#cmyk) that contains number values in a certain interval (check [validate API](/colors-kit-docs/validate-api#cmyk)).
...
**_color:_** An object of type [Hsl](/colors-kit-docs/formats#hsl) that contains number values in a certain interval (check [validate API](/colors-kit-docs/validate-api#hsl)).
...
**_color:_** An object of type [Hsv](/colors-kit-docs/formats#hsv) that contains number values in a certain interval (check [validate API](/colors-kit-docs/validate-api#hsv)).
...
**_color:_** An object of type [Lab](/colors-kit-docs/formats#lab) that contains number values in a certain interval (check [validate API](/colors-kit-docs/validate-api#lab)).
...
**_color:_** An object of type [Rgb](/colors-kit-docs/formats#rgb) that contains number values in a certain interval (check [validate API](/colors-kit-docs/validate-api#rgb)).
