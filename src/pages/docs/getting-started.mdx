...
The **colors-kit** package is built in pure TypeScript and can be used on projects that use vanilla JavaScript or any JavaScript framework.

## Basic Usage

In this section, we will see a simple usage of the **colors-kit** package to convert a color to another format.
