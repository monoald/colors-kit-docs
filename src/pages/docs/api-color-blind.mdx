...
**_color:_** A color of type [BaseColor](/docs/typescript-colors#basecolor), The method will identify the correct format to operate.

### Return value

A color of type [BaseColor](/docs/typescript-colors#basecolor) simulating achromatomaly.
...
A color of type [BaseColor](/docs/typescript-colors#basecolor) simulating achromatopsia.
...
A color of type [BaseColor](/docs/typescript-colors#basecolor) simulating deuteranomaly.
...
A color of type [BaseColor](/docs/typescript-colors#basecolor) simulating deuteranopia.
...
A color of type [BaseColor](/docs/typescript-colors#basecolor) simulating protanomaly.
...
A color of type [BaseColor](/docs/typescript-colors#basecolor) simulating protanopia.
...
A color of type [BaseColor](/docs/typescript-colors#basecolor) simulating tritanomaly.
...
A color of type [BaseColor](/docs/typescript-colors#basecolor) simulating tritanopia.
...
**_colorBlindness:_** A string of type [ColorBlindness](/docs/typescript-colors#colorblindeness).

### Return value

A color of type [BaseColor](/docs/typescript-colors#basecolor) simulating the selected type of color blindness.
